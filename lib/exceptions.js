    ...
    process.on('uncaughtException', function(ex) {
        ...
        if(!suppressInfo.flags.suppressRiemann)
            riemannConnection.riemannClient.send(riemannConnection.riemannClient.Event({description: ex.stack,
                service: exports.servicePrefix + ' : uncaught-exception' + (!!ex.code ? " : " + ex.code : ""),
...
exports.sendUnexpectedException = function(exception, customAttributes) {
    var event = riemannConnection.riemannClient.Event({
        ...
        service: exports.servicePrefix + ' : unexpected-exception' + (!!exception.code ? " : " + exception.code : ""),
        tags: ['georg', 'unexpected-exception'],
        attributes: utils.customAttributesToRiemannFormat(customAttributes)
    });
