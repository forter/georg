 ...
 */
exports.sendUnexpectedException = function(exception, customAttributes, customService) {
    var standardParams = {
        description: errorToMessage(exception),
        service: (customService ? customService : exports.servicePrefix) + ' : exception' + (!!exception.code ? " : " + exception.code : ""),
